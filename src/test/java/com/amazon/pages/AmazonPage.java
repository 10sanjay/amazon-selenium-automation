...
public class AmazonPage {
    ...
    public String searchAndAddToCart(String keyword) {
        ...
        // ── Step 3: Click first matching product ─────────────────────
        //    Amazon opens the product in a NEW WINDOW
        log.info("Clicking first product for keyword '{}'", keyword);
        d.safeClick(firstProduct(keyword));

        // ── Step 4: Switch focus to the new child window ─────────────
        log.info("Switching to child (product) window");
        d.switchToChildWindow();

        // ── Step 5: Click Add to Cart (we are now in the child window) ─
        log.info("Clicking Add to Cart");
        d.safeClick(ADD_TO_CART);

        // ── Step 6: Fetch the cart subtotal price ────────────────────
        ...
        // ── Step 7: Close child window, switch back to parent ─────────
